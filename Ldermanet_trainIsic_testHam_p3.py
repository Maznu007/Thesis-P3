...
if __name__ == "__main__":
    ...
    print("Loaded ISIC weights (classifier adapted for HAM).")
    ...
    conf_matrix_path = os.path.join(ham_result_dir, "ham_isic_dermanet_confusion_matrix.png")
    plt.figure(figsize=(10,8))
    sns.heatmap(cm, annot=True, fmt='d', cmap='Blues',
                xticklabels=test_dataset.classes, yticklabels=test_dataset.classes)
    plt.title(f"ISIC-DermaNet on HAM Confusion Matrix (F1={final_f1:.4f})")
    ...
    # Save Results
    results_txt_path = os.path.join(ham_result_dir, "ham_isic_dermanet_results.txt")
    with open(results_txt_path, "w") as f:
        f.write("="*60 + "\n")
        f.write("ISIC-DermaNet on HAM Model Results\n")
        f.write("="*60 + "\n\n")
    ...
    print(f"✅ HAM Test (ISIC model) complete!")
