...
def main():
    ...
    new_base_dir = r"D:\dataset\isic\Skin cancer ISIC The International Skin Imaging Collaboration"
    results_folder = "hamonisicp3"
    ...
    model_save_path = os.path.join(full_results_path, "regnety320_isic_P3_model.pth")
    results_txt_path = os.path.join(full_results_path, "regnety320_isic_P3_result.txt")
    conf_matrix_path = os.path.join(full_results_path, "regnety320_isic_P3_confusion_matrix.png")
    ...
    for epoch in range(epochs):
        ...
        # ⭐ These lines explicitly store the per-epoch metrics ⭐
        history["train_loss"].append(avg_loss)
        history["train_acc"].append(train_acc)
        history["test_acc"].append(test_acc)
        # ⭐ End of explicit storage ⭐
    ...
    # Using zero_division=0 to handle potential warnings in classification report
    ...
    with open(results_txt_path, "w") as f:
        ...
        # The per-epoch results are written here from the history dictionary
