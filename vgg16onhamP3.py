...
# ===============================
# 0. Paths (UPDATED for HAM10000)
# ===============================
BASE_DIR = r"D:\dataset\ham\organized_ham"
TRAIN_DIR = os.path.join(BASE_DIR, "train") # Changed 'Train' to 'train'
TEST_DIR = os.path.join(BASE_DIR, "test")   # Changed 'Test' to 'test'

# Create the specific output directory for this run
OUTPUT_FOLDER = os.path.join(BASE_DIR, "vgg16onham_P3")
os.makedirs(OUTPUT_FOLDER, exist_ok=True)
print(f"[1/10] Verifying dataset paths and creating output folder: {OUTPUT_FOLDER}...")
...
# ===============================
# 4. Load VGG16 (empty weights)
# ===============================
print("[5/10] Building VGG16 (weights=None)...")
model = models.vgg16(weights=None)          # random initialization
# The VGG16 classifier is: (0): Linear, (3): ReLU, (4): Dropout, (5): Linear, (6): ReLU, (7): Dropout, (8): Linear
# We replace the final fully-connected layer (index 6 in the classifier list)
...
for epoch in range(num_epochs):
    ...
    for batch_idx, (images, labels) in enumerate(train_loader, start=1):
        ...
        # Print progress every 100 batches or at the end
...
# ===============================
# 7. Save model (UPDATED path)
# ===============================
model_path = os.path.join(OUTPUT_FOLDER, "vgg16_ham_model.pth")
...
# Classification Report (UPDATED path)
report = classification_report(all_labels, all_preds, target_names=class_names)
results_path = os.path.join(OUTPUT_FOLDER, "result.txt")
