...
for Skin Lesion Classification on PAD Dataset
"""
...
def main():
    print("🚀 Starting DermaNet-Attention training on PAD Dataset...")
    ...
    model_save_path = os.path.join(base_dir, "DermaNet_PAD_model.pth")
    results_txt_path = os.path.join(base_dir, "DermaNet_PAD_results.txt")
    conf_matrix_path = os.path.join(base_dir, "DermaNet_PAD_confusion_matrix.png")
    # --------------------------------
    ...
    plt.title(f"DermaNet-PAD Confusion Matrix (F1={final_f1:.4f})")
