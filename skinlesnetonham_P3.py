...
def main():
    ...
    # =================================================================
    # PATHS (UPDATED for HAM10000 and new output folder)
    # =================================================================
    ...
    OUTPUT_FOLDER = os.path.join(base_dir, "skinlesnetonham_P3")
    ...
    plt.title("HAM10000 SkinLesNet Confusion Matrix")
